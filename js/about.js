...
{setHeader();});initMenu();initMilestones();initTestSlider();function setHeader()
...
{var testSlider=$('.test_slider');testSlider.owlCarousel({items:1,autoplay:false,loop:true,dots:true,smartSpeed:1200});}}});